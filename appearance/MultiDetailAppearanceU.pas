...
begin
  ...
  Text.DefaultValues.Font.Style := [TFontStyle.fsBold];
  ...
  FMultiDetail1.DefaultValues.Font.Style := [];
...
begin
  ...
  try
    ...
    if Image.ActualWidth > 0 then
      Text.InternalPlaceOffset.X := 70 // Force the text to start at 70 to match your other objects
    else
